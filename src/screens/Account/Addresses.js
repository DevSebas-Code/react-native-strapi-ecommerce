...
export default function Addresses() {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            {!addresses ? (
                <ActivityIndicator size="large" style={styles.loading} color="00ff00" />
            ) : size(addresses) === 0 ? (
                // Else If the return of size() is 0, it means that there's no direction asociate to the user yet
